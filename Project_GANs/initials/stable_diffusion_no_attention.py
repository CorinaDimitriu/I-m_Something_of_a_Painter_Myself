...
class NoiseScheduler(torch.nn.Module):
    ...
    def forward_diffusion_sample(self, x_0, t, device=torch.device("cuda")):
        ...
        # mean + variance
        return sqrt_alphas_cum_prod_t.to(device) * x_0.to(device) + sqrt_one_minus_alphas_cum_prod_t.to(
